        ...
        <div class="col-12 col-sm-10 col-md-10 align-items-center my-auto">
            <form action="{{route('create.class')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="classCode" id="classCode" class="form-control" placeholder="Enter your clascode" value="{{old('clascode')}}">
                    <span class="text-danger">@error('classCode'){{$message}} @enderror</span>
                </div>
                <div class="form-group">
                    <label for="email">email</label>
                    <input type="text" name="email" id="email" class="form-control" placeholder="Enter your clascode" value="{{old('clascode')}}">
